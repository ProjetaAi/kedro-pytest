...
class TestKedro:
    ...
    def run(self,
        ...
        Example:
            ...
            >>> print(res.output)  # doctest: +ELLIPSIS, +NORMALIZE_WHITESPACE
            [...] INFO Kedro project test_dummy0...
                  INFO Loading data from 'my_pipeline-input'...
                       (CSVDataSet)...
                  INFO Loading data from 'params:my_pipeline-param'...
                       (MemoryDataSet)...
            ...
